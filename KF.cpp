...
void KF::kalman(float x[2], float P[4],float u,float z)
{
  ...
  float P11p = (this->_A[0]) * (this->_A[0] * P[0] + this->_A[1] * P[2]) + (this->_A[1]) * (this->_A[0] * P[1] + this->_A[1] * P[3])+this->_Q[1];
  float P12p = (this->_A[2]) * (this->_A[0] * P[0] + this->_A[1] * P[2]) + (this->_A[3]) * (this->_A[0] * P[1] + this->_A[1] * P[3])+this->_Q[2];
  float P21p = (this->_A[0]) * (this->_A[2] * P[0] + this->_A[3] * P[2]) + (this->_A[1]) * (this->_A[2] * P[1] + this->_A[3] * P[3])+this->_Q[3];
  float P22p = (this->_A[2]) * (this->_A[2] * P[0] + this->_A[3] * P[2]) + (this->_A[3]) * (this->_A[2] * P[1] + this->_A[3] * P[3])+this->_Q[4];
